...
class Agent(Environment,Buffer):
    ...
    def get_actor(self,name='Actor'):
        model_name              = name
        self.models[model_name] = {'model_path'     : self.savelocation + model_name + '.keras',
                                   'mtd_model_path' : self.savelocation + model_name + '_maxtime.keras',
                                   'msd_model_path' : self.savelocation + model_name + '_maxscore.keras'}
